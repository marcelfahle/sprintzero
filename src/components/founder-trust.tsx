        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-2">
          ...
          <article className="flex items-start gap-6">
            ...
            <div className="flex flex-col gap-2.5">
              ...
              <p className="text-[16px] leading-[1.65] text-fg-secondary">
                25+ years building and rescuing software. He leads every engagement personally — not
                farming your project out to subcontractors. When we say &ldquo;shipped in 30
                days,&rdquo; he&apos;s the one writing the code.
              </p>
