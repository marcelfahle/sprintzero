    ...
    <>
      ...
      <main>
        ...
        >
          ...
          >
            <p>
              The same client that bought our frontend sprint came back with a backend they
              couldn&apos;t sit on much longer.
            </p>
            <p>
              Seven Laravel services across two major versions. Repos still targeting PHP 7.3, 7.4,
              and 8.0.2. Local stack files pointing at MySQL 5.7. The Docker setup still carrying a
              Node 8 build path for legacy assets. It looked like microservices. It behaved like a
              distributed monolith — services calling each other directly over HTTP for day-to-day
              domain behavior, shared service-registry code baked into multiple repos, route
              versioning duplicated across the stack. They were paying the microservice tax without
              getting any of the upside.
            </p>
            ...
            <p>
              ...
              . No CI. No contract tests. No dependency audit pipeline. Plus the kind of security
              debt that doesn&apos;t survive a real HIPAA risk analysis: weak authentication
              boundaries, credential management gaps, missing access controls on internal routes,
          ...
          <CaseStudySection overline="The numbers" title="Audit findings.">
            <MetricsTable rows={auditRows} beforeLabel="—" afterLabel="Audit finding" />
          </CaseStudySection>
          ...
          >
            <p>
              The backend isn&apos;t unfixable. It&apos;s just not a &ldquo;bump the
              dependencies&rdquo; job. Pretending otherwise is what gets you a Friday-night
              incident.
            </p>
            <p>
              Our audit gave the leadership team a clear, sequenced path: contain the risk first,
              build the safety net second, do the staged upgrades third, and consider architecture
              simplification only after the platform is stable. No giant rewrite. No &ldquo;merge
              everything next month&rdquo; plan. Real work, in real order.
            </p>
            <p>
              It also gave them a defensible story for buyers, partners, and HIPAA risk analysis.
              Security posture shows up in diligence. It shows up in procurement. It shows up the
              moment one customer asks how access to PHI is controlled. Now there&apos;s an answer.
            </p>
          </CaseStudySection>
          ...
          >
            <p>
              Read-only access to every repo. Senior engineering analysis, not automated scanner
              output. Findings prioritized by exploit risk and operational impact, not just CVE
              severity score. Phased recommendations with rough timing per phase, so leadership can
              plan around it. A risk picture written for both the technical lead and the executive
              team, in language each of them actually uses.
            </p>
            <p>
              That&apos;s the SprintZero pattern: serious engineering, written like adults are
              reading it.
            </p>
          </CaseStudySection>
          ...
          <CaseStudyCallout>
            ...
            <p className="mt-1 text-[15px] text-fg-secondary">
              A first-time engagement is a sale. The same client coming back for a second engagement
              is a referendum. They saw what we delivered on the frontend, and they handed us the
              backend.{" "}
              <Link
          ...
          >
            <p>
              If you&apos;re running on aging Laravel, weighing whether to stay distributed or
              consolidate, or carrying compliance exposure you can&apos;t keep ignoring — the audit
              pattern here is what the Codebase X-Ray gives you. One week. Real findings. A real
              plan, in priority order. With a sprint scope and price attached.
            </p>
          </CaseStudySection>
